...
export const CHANGELOG = [
  {
    ...
    title: '細かな不整合の修正と整理',
    changes: [
      '日記タブのバッジ件数を日記一覧の表示（「行きたい」を除く）と一致するよう修正',
      '場所検索の候補タップが二重に反応することがある不具合を修正',
      '未使用のカレンダー連携コードを削除',
    ],
  },
  {
    version: '2.5.1',
    date: '2026-06-29',
    title: '起動とエラー復旧の不具合を修正',
    changes: [
      '初回起動時に画面が一瞬リロードされ、入力中の内容が消えることがある不具合を修正',
      'マップ読み込み失敗時の復旧ボタンが、設定やタグを誤って消していたのを「再読み込み」に変更',
    ],
  },
  {
    version: '2.5.0',
    date: '2026-06-28',
    title: 'ランキング・「また行きたい度」機能',
    changes: [
      '日記タブに「ランキング」を追加（上位3件はメダル表示）',
      'ランキングを「⭐️評価」と「また行きたい」で切り替え可能に',
      '記録に「また行きたい度」（♡1〜5の5段階評価）を追加',
    ],
  },
  {
    version: '2.4.7',
  ...
  },
  {
    ...
    title: '日付・件数の不整合を修正',
    changes: [
      '日付を空のまま保存でき、その記録がカレンダーから消える不具合を修正（空の場合は当日に補完）',
      'カレンダーとプロフィール件数から「行きたい」を除外し、一覧・統計と表示を統一',
    ],
  },
  {
    version: '2.4.4',
    date: '2026-06-27',
    title: 'データ消失リスクなどのバグ修正',
    changes: [
      'IndexedDBが使えない環境（プライベートブラウズ等）で記録がリロードで消える不具合を修正（localStorageへ自動退避）',
      '起動直後に追加した記録が読み込み完了時に上書きされて消える不具合を修正',
      '現在地ボタンの位置監視が解除されず動き続ける不具合を修正（30秒で自動停止）',
      '不正な撮影日（例: 2月31日）で日付が空になる不具合を修正',
      '地図タップ時に古い逆ジオコーディング結果が新しい地名を上書きする不具合を修正',
    ],
  },
  {
    version: '2.4.3',
  ...
  },
  {
    ...
    title: '新機能追加・重要バグ修正',
    changes: [
      '【重要】写真の保存先をIndexedDBに移行（容量上限で画像が消える不具合を解消）',
      '起動時に毎回位置情報を聞かれる問題を修正（自動取得をやめ、現在地ボタン押下時のみに）',
      '起動時に下タブがずれる問題を修正（実画面高さでレイアウトを確定）',
      '「行きたい」を「行った」に変換するボタンを追加',
      '写真の撮影日時(EXIF)から日付を自動入力',
      'ふりかえり統計を追加（月別記録・平均評価・よく使うタグ・よく行く場所）',
      'マップのピンをズームアウト時にまとめて表示（クラスタリング）',
      'オフライン対応（電波が弱くてもアプリが開けるように）',
    ],
  },
  {
    version: '2.2.0',
